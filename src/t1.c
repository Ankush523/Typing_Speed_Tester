...
{       
	...
	{       case 1:startgame();break;
			...
			case 3:sett();main();break;
			case 4:help();break;
			case 0:system("cls");gotoxy(17,10);printf(" Game created by Team 4 ");delay(1000);exit(1);
			default:main();
	}
getch();
}
...
{       
	...
	pos;
	setcolor(12);
	printf("..SELECT THE MODE YOU WANT TO PLAY..");pos;
	ln
	pos;
	printf("1.Easy mode");
	pos;
	...
	else
	{
		...
		{       
			...
			{       
				...
				gotoxy(37,9);
				printf("Time-taken : %d sec",time_spent);//prints time spent during game
		...
		{       setcolor(11);
			...
			if(speed>50)
			{
				printf("GREAT !!! You got Gold medal");
			}
			else
			printf("Sorry !!! you need practice...");
		}
		pos;
		...
		switch(ch)
		{
		      ...
		      case 2:main();break;
		      case 3:system("cls");gotoxy(17,10);printf("..Game created by Team 4..");delay(1000);exit(1);
